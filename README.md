...
<div style="background: linear-gradient(45deg, #f3f4f6, #ffffff); padding: 20px; border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.1); margin: 20px 0;">
  <h3 style="color: #2d3436; font-family: 'Segoe UI', sans-serif;">🤝 Connect with me:</h3>
...
<div style="background: linear-gradient(45deg, #f3f4f6, #ffffff); padding: 20px; border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.1); margin: 20px 0;">
  <h3 style="color: #2d3436; font-family: 'Segoe UI', sans-serif;">🛠 Tools I Love</h3>
  <div style="display: flex; gap: 10px; flex-wrap: wrap;">
...
<div style="background: linear-gradient(45deg, #f3f4f6, #ffffff); padding: 20px; border-radius: 15px; box-shadow: 0 0 20px rgba(0,0,0,0.1); margin: 20px 0;">
  <h3 style="color: #2d3436; font-family: 'Segoe UI', sans-serif;">📊 GitHub Analytics</h3>
  <table>
    <tr>
      <td>
